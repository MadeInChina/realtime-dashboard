package org.hanrw.app.kafka.config;
...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, NewUser> producerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, NewUser> ioTDataKafkaTemplate() {
        KafkaTemplate<String, NewUser> kafkaTemplate =  new KafkaTemplate<>(producerFactory());
